...
function start(){
  var [inputRed, inputGreen, inputBlue] = document.querySelectorAll("input[type='range'");
  var [numberRed, numberGreen, numberBlue] = document.querySelectorAll("input[type='text'");
